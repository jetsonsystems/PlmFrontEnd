...
define(
  ...
  function(PageSlide, $, _, Backbone, Plm, MsgBus, Router) {
    !Plm.debug || console.log('/js/app/property-manager/app: Loading, typeof MsgBus - ' + typeof(MsgBus) + ', typeof Router - ' + typeof(Router));

    var initialize = function() {
      !Plm.debug || console.log('/js/app/property-manager/app: Initializing...');
